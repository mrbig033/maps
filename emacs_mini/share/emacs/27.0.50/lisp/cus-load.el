...
(put 'mouse 'custom-loads '(artist avoid goto-addr msb mwheel strokes))
...
(defvar custom-versions-load-alist '(("19.29" time-stamp) ("20" ps-print ebnf2ps) ("20.1" time-stamp) ("20.3" dabbrev paren add-log debug msb uce ffap cus-edit find-func diary-lib browse-url rmail compile xscheme avoid which-func hexl vcursor) ("20.3.3" dos-vars) ("20.4" sh-script compile hilit-chg) ("20.8" sql) ("21.1" paren debug server rmailedit vc sgml-mode hideshow cal-hebrew ange-ftp gnus-group vc-sccs cperl-mode latin1-disp net-utils smtpmail find-func fortran gnus-agent cus-edit flyspell etags sendmail rmail browse-url vc-cvs strokes message gnus-start wid-edit gnus-sum ezimage nnmail gnus-art dabbrev add-log vc-rcs ps-print sb-image) ("21.3" ange-ftp sql gnus-agent) ("22" ps-print ebnf2ps) ("22.1" sql tcl cal-tex sh-script ange-ftp comint spam gnus-int bookmark view fortran gnus-delay mail-extr flow-fill vc-cvs imap ffap mm-view ispell find-func dabbrev info x-dnd org-faces hi-lock gnus-cite add-log binhex shadowfile latin1-disp glasses calendar cal-dst mm-util compare-w gnus-util time warnings autorevert make-mode hl-line mail-source mml-sec gnus-start fringe ielm gnus-srvr rmail vc-svn mm-url tex-mode imenu descr-text gnus-score gnus-agent gnus-group allout keypad locate uudecode mm-decode mm-uu server deuglify compile dnd dired gnus-art mml vc desktop gdb-mi grep nnmail mml2015 diary-lib gnus-fun sendmail smime message gnus-msg diff-mode sgml-mode gnus-sum pop3 gnus cus-edit gnus-win) ("22.2" vc-mtn mail-source bibtex-style find-dired vc-hg sql gnus-sum gdb-mi css-mode desktop dired) ("22.3" message) ("23.1" mm-decode gnus-score copyright gnus-dired filesets f90 rmail vc-cvs smime hideif pop3 face-remap gnus smiley imap info vc-git spam-report vc-hg allout descr-text gnus-bookmark woman misearch cus-edit checkdoc server informat nnmail holidays view gnus-util dired-aux tex-mode vc-mtn message compile gnus-draft mm-uu sendmail browse-url mml gnus-group pcmpl-unix fortune gnus-sum nnmairix gnus-msg bibtex rmailmm gdb-mi calendar time gnus-art fortran ffap) ("23.2" rmailmm gnus-sum bytecomp dired tramp-gvfs lunar doc-view diary-lib gnus-group desktop ansi-color calendar rmail comint help-fns message auth-source gdb-mi mm-encode elint) ("23.3" rmail diary-lib calendar desktop rmailsum) ("23.4" ede) ("24.1" erc-button compile em-term cus-edit sieve-manage dirtrack em-script em-unix gnus-srvr esh-arg woman ibuffer ob-R cus-theme org-src pcmpl-unix mml2015 vc-sccs esh-io vc-cvs vc vc-rcs doc-view dired-x org-inlinetask em-cmpl vc-git org-archive gssapi ob-picolisp em-pred esh-ext ob-lisp netrc man em-rebind rmail server gnus-msg log-edit esh-mode esh-cmd etags cc-vars auth-source message org-attach org-keys ob-exp elec-pair f90 appt org-entities gnus-html js tramp ob-ditaa ange-ftp esh-util cc-guess gnus allout org-crypt org-list battery ses em-hist em-smart flyspell smtpmail erc-backend gnus-picon verilog-mode org-clock cl-indent erc-join gnus-start org-capture gnus-registry org-table gnus-sum org-mobile esh-proc rcirc ob-core esh-var pop3 copyright ob-plantuml ox-icalendar diary-lib vc-svn em-alias ol-bibtex org-ctags calendar ob-tangle org-habit nnir cc-fonts find-dired shr image-mode package-x mml emacs-lock browse-url mm-view em-banner smiley calc feedmail url-queue ob-js allout-widgets em-glob gnus-int hl-line info ido ox-odt gnus-art vc-bzr arc-mode gnus-util saveplace em-prompt url-cache glasses package bibtex sendmail org-agenda em-ls org sql ol gnus-gravatar gnus-group rst prolog em-dirs org-faces) ("24.2" which-func) ("24.3" sh-script ffap erc-match rcirc vhdl-mode proced message tramp ol org ob-C calc gnus-picon image calendar icalendar ido server nnmail gdb-mi emacs-lock smerge-mode avoid debug which-func flymake org-datetree allout em-term verilog-mode org-capture bug-reference ediff-wind pcmpl-gnu erc-backend wdired cus-edit sql ob-groovy ob-java apropos compile pcmpl-rpm diff-mode ox-odt org-id tramp-smb perl-mode cal-html semantic/complete gnus-msg reftex-vars man minibuf-eldef org-agenda hexl) ("24.4" ob-core find-file org-archive ansi-color info-xref timeclock package em-term org-attach-git man org-clock flyspell tramp-cache sieve-manage org-mobile gnutls ido idlwave pcmpl-x smie js ruby-mode ox-texinfo apropos ol-gnus ob-ruby vc-svn org-src verilog-mode cfengine m4-mode epa dired mml-smime cookie1 flymake-proc rmail autorevert message imenu recentf ob-python tramp-sh calc python tramp unrmail strokes nnimap ob-ditaa mm-util bibtex gdb-mi tramp-smb gnus-sum gnus-start mml2015 calendar term saveplace compare-w org-faces icomplete type-break rlogin ox-odt remember sh-script info pop3 ede/linux elec-pair flymake bookmark gnus org-protocol quickurl shr octave reftex-vars doc-view ox-latex eww sql tramp-adb desktop org ox-ascii ox-html hi-lock log-edit ox-beamer ob-lilypond ob-ocaml f90 vhdl-mode ox-man ox org-agenda) ("24.5" erc-stamp vc-hg flyspell erc mml2015) ("25.1" check-declare diff-mode vc tex-mode vc-mtn rcirc vc-bzr vc-hg rect filecache ls-lisp find-func js shr rmailmm info sgml-mode vc-annotate epg-config newst-treeview newst-reader tramp-adb net-utils url-tramp vc-cvs erc eudc-vars gnus-sum cl-indent xt-mouse gud whitespace paren tildify checkdoc calendar mml-sec vc-svn url-handlers nsm ldap icalendar em-term package gnus-art browse-url mm-decode compare-w erc-desktop-notifications arc-mode gdb-mi sql eww verilog-mode gnus-fun python vhdl-mode vc-git gnus-registry hideif sh-script) ("25.2" ffap tramp-sh) ("26.1" debug org-src perl-mode ox-beamer sieve-manage ox-ascii tramp-sh checkdoc cpp enriched package bibtex browse-url org-attach ox-html shr ob-J org-faces org-clock flyspell man epa bytecomp ediff-init ob-scheme dunnet ruby-mode dired-x ox-md url-vars org-table battery mhtml-mode tramp ol-bbdb comint term sql org-colview ibuf-ext gdb-mi tex-mode edebug ob-exp vc-git org-duration org-timer dns-mode ibuffer js ox-odt ol-bibtex message icomplete ob-core flymake ob-vala org-attach-git net-utils ox-publish css-mode ob-lua gnus-art wdired ox-texinfo mwheel ob-clojure vc-hg mailcap python ange-ftp grep image ob-lisp ox dired gnus-mh quickurl executable cc-vars org-keys org-agenda ox-latex display-line-numbers gnus-cloud org erc add-log image-dired) ("26.2" imenu image calc mail-source shadowfile) ("26.3" help-fns) ("27.1" bytecomp epg-config remember url-vars auth-source comint ido server network-stream vc-dispatcher auth-source-pass flymake-cc tar-mode flymake rmailout vc-git tramp-cmds term mwheel thread image vc-hg cc-vars tree-widget autorevert shell rcirc hideif nxml-mode em-term org vc package gnus-win edebug windmove tramp-gvfs tramp-sh tramp-rclone nnmail gnus-sum sendmail pcmpl-gnu ox-texinfo shr image-dired project backtrace smtpmail erc-button dired time-stamp char-fold doc-view autoinsert winner cua-base mm-decode find-dired grep xref esh-mode arc-mode bibtex bookmark erc compile tramp gnus-art dired-aux flymake-proc eww nsm verilog-mode cus-edit browse-url gnus-async gud python footnote message display-fill-column-indicator image-converter hi-lock add-log sql reftex-vars gravatar mm-uu js gnutls tex-mode tab-line diff-mode nnir flyspell))
